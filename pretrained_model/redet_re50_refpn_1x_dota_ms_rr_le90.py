...
data = dict(
    ...
    train=dict(
        type='DOTADataset',
        ann_file='datasets/split_ms_dota1_0/trainval/annfiles/',
        img_prefix='datasets/split_ms_dota1_0/trainval/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RResize', img_scale=(1024, 1024)),
    ...
    test=dict(
        type='DOTADataset',
        ann_file='datasets/split_ms_dota1_0/test/images/',
        img_prefix='datasets/split_ms_dota1_0/test/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
